...
namespace eBatch.ResourceAccess
{
    public class BatchRal
    {
        ...
        public List<Batch> GetBatchDT(int? ur = null, int? dl = null, string un = null)
        {
            ...
            var res = Db.FetchDT<Batch>(SPEnum.spGetUsers.ToString(), dynParams);
            return res;
        }
        ...
        //public List<Batch> GetBatchRole(Batch batch)
        //{
        //    //var dynParams = new DynamicParameters();
        //    //dynParams.Add("@UserId", User.id);
